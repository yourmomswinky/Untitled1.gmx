...
draw_set_colour(make_colour_rgb(43, 179, 206));
draw_set_alpha(0.5);
draw_rectangle(xVal, yVal, xVal+boxWidth, yVal+boxHeight, false);

draw_set_colour(make_colour_rgb(34, 108, 173));
draw_set_alpha(1);
draw_rectangle(xVal, yVal, xVal+boxWidth, yVal+boxHeight, true);

// draw the text into the box
draw_set_colour(c_black);
draw_set_font(fnt_text_box);
draw_text_ext(xVal+padding, yVal+padding, text, lineDistance, width);
