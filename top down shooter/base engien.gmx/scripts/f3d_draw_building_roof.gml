/// f3d_draw_building_roof(height, relative, leftSpr, rightSpr, bottomSpr, topSpr, roofSpr)
...
draw_sprite_pos(bottomSprite, 0,    mn_botLeftX, mn_botLeftY, mn_botRightX, mn_botRightY,
                                    lef_botLeftX, lef_botLeftY, rgt_botRightX, rgt_botRightY, alpha);

// top wall
draw_sprite_pos(topSprite, 0,       mn_topLeftX, mn_topLeftY, mn_topRightX, mn_topRightY,
                                    lef_topLeftX, lef_topLeftY, rgt_topRightX, rgt_topRightY, alpha);
*/
// roof
draw_sprite_pos(roofSprite, 0,      lef_topLeftX, lef_topLeftY, rgt_topRightX, rgt_topRightY,
